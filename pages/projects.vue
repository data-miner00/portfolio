    ...
    <div class="wrap">
      ...
      >
        <p>
          ...
          <span>not related</span> to technology while continuously improving
          and <span>consolidating</span> my writing skills in various languages.
          It takes a lot of effort (~7 days) to plan, outline, write, enhance
          and proofreading to ensure quality of the blog post. As a result, I
          post relatively slowly as I did not have the time solely dedicated for
      ...
      <Project
        ...
        websiteUrl="https://portfolio-six-ecru-52.vercel.app/"
      >
        <p>
      ...
      >
        <p>
          Positron+ is a web application that allows user to send Ethereum to
          another user along with a random GIF as well as a piece of message
          that will be persisted on the Ethereum blockchain via a smart
          contract. It started out as a code along project with a tutorial by
          Mastering JS on Youtube. However as I follow along, I decide to
          develop my way by redesigning the UI and using another smart contract
          framework.
        </p>
        <p>
      ...
      >
        <p>
          ...
          aesthetically pleasing UI around the Hackernews API as the UI in the
          actual website is something looks like from the oldies. However, I
          took me over 2 years+ and I have yet to complete this project. This
          effectively shows how busy (lazy) I am. I referenced the slick black
          and white newspaper themed UI from The New York Times and it was a
          blast. I have added the favourite feature that is persisted via
      ...
      >
        ...
        <p>
          ...
          useful for developing with React and hence it is quite opionionated.
        </p>
      </Project>
      <Project
      ...
      >
        <p>
          An experimental React template written with F# and JavaScript. The F#
          code is transpiled to JavaScript by the Fable compiler and Feliz for
          React bindings. Esbuild is used to compile the generated JavaScript
          files into a bundle. There are still a lot of bugs and missing
